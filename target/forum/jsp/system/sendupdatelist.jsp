...
<form class="form-horizontal modal-open"  method="post" id="myForm" >
    ...
    <div class="form-group">
        ...
        <div class="col-sm-4">
            <input type="text" class="form-control" id="theme" name="theme" value="${requestScope.send.theme}" readonly="readonly">
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-4">
            <textarea type="text" class="form-control" id="content" name="content"  rows="5">${send.content}</textarea>
        </div>
    </div>
    ...
    <a class="btn btn-info" href="<%=basePath %>systemsend/list2">返回账户管理页面</a>
</form>
</body>
</html>
