...
<head>
    ...
    <script>
        $(function () {
            ...
            $("button[name='addcus']").click(function() {
                ...
                $.post("<%=basePath%>customer/add",
                    ...
                    function(data) {
                        ...
                        if(data.status == 1) {
                            ...
                            window.location.href = "<%=basePath%>customer/login1";
                        }
                    }
                );
...
<div class="container" style="top: 40%;">
    <a href="<%=basePath%>"><img alt="" src="<%=basePath%>img/logozc.png"></a>
    ...
    <form id="myForm" method="post" class="form">
        ...
        <button id="customerReset_Button" class="btn" type="button" name="addcus">同意以上协议并注册</button>
    </form>
    <div class="ext">
        <a class="signup" href="<%=basePath%>customer/login1">已有账号?立即登录</a>
    </div>
</div>
<div class="footer">
