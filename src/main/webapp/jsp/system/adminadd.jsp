            ...
            $("button[name='addAdmin']").click(function() {
                ...
                $.post("<%=basePath%>system/add",
                    ...
                    function(data) {
                        ...
                        if(data.status == 1) {
                            window.location.href = "<%=basePath%>system/list";
                        }
                    }
                );
            });
                    ...
                    $.post("<%=basePath%>system/add",
                        ...
                        function (data) {
                            ...
                            if (data.status == 1) {
                                ...
                                location.href = "<%=basePath%>system/list";
                            } else {
                                alert("添加失败!管理员账户已存在!");
                            }
                        });
...
<form class="form-horizontal modal-open"  method="post" id="myForm">
    ...
    <h1 style="margin: 20px; auto auto 50px; ">添加管理员</h1>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-6">
            <button name="addAdmin" class="btn btn-primary btn-lg" type="button" >确认</button>
        </div>
    </div>
</form>
</body>
